...
public void request_login(){
    ...
    String password = getpass.getpass(prompt="Please enter your password: ", stream=None) 
...
public void show_options(){
    System.out.println("1. Upload a signature");
    System.out.println("2. Upload pdf file");
    System.out.println("3. Request a signature");
    System.out.println("4. Sign a document");
    System.out.println("5. Generate pdf file");
    System.out.println("6. List all signature requests approved");
    System.out.println("7. List all signature requests pending");
    System.out.println("8. List all of my pending signature requests");
    System.out.println("9. Signature history");
    System.out.println("10. Logout");
            }

public static void upload_signature(){
//    global user
...
public static void request_signature(){
//    global user
...
public static void sign_document(){
...
//public static void list_all_signature_requests(approved: bool){
//    my_request_signature = services.get_request_signature_by_user(user.id)
...
public static void list_all_my_pending_signature_requests(){
//    my_request_signature = services.get_list_signature_request_user_by_user_id_and_signed(user.id, False)
...
public static void list_all_signature_history(){
